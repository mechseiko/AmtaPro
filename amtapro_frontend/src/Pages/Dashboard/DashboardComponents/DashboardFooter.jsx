...
import {logo, email, mail, socialLinks, legalLinks} from '../assets/dashboardLinks'
...
const Footer = () => {
  ...
  return (
    <div>
      <footer className="bg-gray-900 text-center text-white px-6 py-10">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-10 p-5 text-left">
          ...
          <div className="flex flex-col items-center text-center md:text-left md:items-start max-w-md">
            <img className="rounded-full size-20 mb-4" src={logo} alt="Amtapro-logo" />
            <p className="text-sm">
            ...
            <a href={email} className="mt-3 text-blue-500 underline">{mail}</a>
          </div>
        </div>
